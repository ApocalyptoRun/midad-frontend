...
const PhoneNumber = ({navigation}) => {
  ...
  const sendPhoneNumber = () => {
    ...
    axios.post(`${BASE_URL}/auth/sendOTP`, postData)
    .then((response) => {
  ...
  return (
    <SafeAreaView style={styles.area}>
      ...
      <View >
          <Text style={{ ...FONTS.h2, textAlign:'center'}}>Enter Your Phone Number</Text>
          <Text style={{ ...FONTS.h4, textAlign:'center'}}>We will send you a verification code</Text>
        ...
        <View style={styles.inputContainer}>
          ...
          >
              ...
              <View style={{ justifyContent: 'center' }}>
                <Text style={{ color: COLORS.black, fontSize: 13 }}>+{ selectedCountry.callingCode }</Text>
              </View>
